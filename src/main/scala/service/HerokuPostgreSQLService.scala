...
package com.scleradb.plugin.dbms.rdbms.heroku.service
...
import com.scleradb.plugin.dbms.rdbms.heroku.location.HerokuPostgreSQL

class HerokuPostgreSQLService extends DBService {
    override val id: String = HerokuPostgreSQL.id
    ...
    ): HerokuPostgreSQL = new HerokuPostgreSQL(
